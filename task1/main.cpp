...
int main()
{
	...
	std::cout << "Address is " << *(wps) << std::endl; // I changed wp to wps since it gave me problems because the compiler thinks it is weakptr and not my class
}
